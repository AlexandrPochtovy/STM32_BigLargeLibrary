...
void DMA_Ch2_IRQ_Callback(DMA_TypeDef *DMAnum);
void DMA_Ch3_IRQ_Callback(DMA_TypeDef *DMAnum);
void DMA_Ch4_IRQ_Callback(DMA_TypeDef *DMAnum);
void DMA_Ch5_IRQ_Callback(DMA_TypeDef *DMAnum);
void DMA_Ch6_IRQ_Callback(DMA_TypeDef *DMAnum);
void DMA_Ch7_IRQ_Callback(DMA_TypeDef *DMAnum);
/*----------------------------------------------------------------------------*/
