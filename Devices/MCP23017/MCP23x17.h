...
uint8_t MCP23_17_Write(I2C_IRQ_Connection_t *_i2c, MCP23_t *dev, uint8_t reg, uint8_t *data, uint8_t len);
uint8_t MCP23_17_Read(I2C_IRQ_Connection_t *_i2c, MCP23_t *dev, uint8_t reg, uint8_t *data, uint8_t len);
