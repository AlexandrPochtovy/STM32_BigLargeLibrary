...
/*	control function	******************************************/
void I2C_Start_IRQ(I2C_Connection_t *_i2c);//запускает обмен и устанавливает флаг "занято" для устройства
void I2C_Start_DMA(I2C_Connection_t *_i2c);//запускает обмен и устанавливает флаг "занято" для устройства
void ClearBusyI2C1(void);//сбрасывает флаг зависшей шины согласно эррате
/*	interrupt processing function	******************************/
void I2C_Raw_IRQ_CallBack(I2C_Connection_t *_i2c);
void I2C_EV_IRQ_DMA_CallBack(I2C_Connection_t *_i2c);
void I2C_ERR_IRQ_CallBack(I2C_Connection_t *_i2c);
