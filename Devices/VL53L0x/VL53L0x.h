...
void setupVL53L0X(VL53L0X *lidar, uint16_t lim);
//----------------------------------------------------------------
...
uint8_t setMeasurementTimingBudget(I2C_IRQ_Conn_t *_i2c, VL53L0X *lidar, uint32_t budget_us);
//----------------------------------------------------------------
...
uint8_t setVcselPulsePeriod(I2C_IRQ_Conn_t *_i2c, VL53L0X *lidar,
